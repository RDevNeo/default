...
local Types = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Types)

-- TYPES
export type Icon = Types.Icon

local iconModule = script
local Reference = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Reference)
...
-- MODULES
local Signal = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].GoodSignal)
local Janitor = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Janitor)
local Utility = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Utility)
local Themes = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Features.Themes)
local Gamepad = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Gamepad)
local Overflow = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Overflow)
local Icon = {}
Icon.__index = Icon
...
Icon.baseTheme = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Features.Default)
Icon.isOldTopbar = false -- Logic has been moved to Container
Icon.iconsDictionary = iconsDict
Icon.insetHeightChanged = Signal.new()
Icon.container = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Container)(Icon)
...
task.defer(function()
	...
	require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Attribute)
end)
...
function Icon.new()
	...
	local widget = janitor:add(
		require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Widget)(self, Icon)
	)
	self.widget = widget
	self:setAlignment()
...
function Icon:notify(customClearSignal, noticeId)
	...
	if not notice then
		notice = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Notice)(self, Icon)
		self.notice = notice
	end
...
function Icon:setCaption(text)
	...
	local caption = captionJanitor:add(
		require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Caption)(self)
	)
...
function Icon:getDropdown()
	...
	if not dropdown then
		dropdown = require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Dropdown)(self)
...
function Icon:setIndicator(keyCode)
	...
	if not indicator then
		indicator = self.janitor:add(
			require(ReplicatedStorage.Packages._Index["foreverhd_topbarplus@1.0.0"].Elements.Indicator)(self, Icon)
		)
